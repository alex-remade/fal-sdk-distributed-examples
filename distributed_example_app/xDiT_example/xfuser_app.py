...
class XFuserApp(
    ...
    async def setup(self) -> None:
        ...
        # Import from cloned repository (updated path for new structure)
        print("Attempting to import distributed_example_app.xDiT_example.engine...")
        from distributed_example_app.xDiT_example.engine import Engine
